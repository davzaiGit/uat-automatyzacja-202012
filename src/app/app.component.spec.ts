...
describe('AppComponent', () => {
  ...
  it('should accept valid PESEL numbers', () => {
    ...
    expect(component.isValidPesel('90833016899')).toBe(true);
    expect(component.isValidPesel('30633003848')).toBe(true);
  });
  ...
  it('should reject PESEL numbers with invalid controlNumber', () => {
    ...
    expect(component.isValidPesel('90833016898')).toBe(false);
    expect(component.isValidPesel('30633003843')).toBe(false);
  });
